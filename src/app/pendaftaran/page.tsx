    ...
    return (
        <div className="pt-24 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            <div className="text-center mb-16">
                <span className="inline-block px-4 py-1.5 rounded-full bg-gold/10 text-emerald-800 font-bold text-sm mb-4 border border-gold/20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-card border border-emerald-50">
                        ...
                        <div className="space-y-6 border-l-2 border-emerald-100 pl-6 ml-3">
                            <div className="relative">
                                <span className="absolute -left-[31px] top-1 w-4 h-4 rounded-full bg-emerald-500 ring-4 ring-white"></span>
                                <h4 className="font-bold text-gray-900">Gelombang 1</h4>
                                <p className="text-emerald-700 font-medium text-sm mb-1">Januari - Maret 2026</p>
                            ...
                            <div className="relative">
                                ...
                                <h4 className="font-bold text-gray-900">Gelombang 2</h4>
                                <p className="text-emerald-700 font-medium text-sm mb-1">April - Juni 2026</p>
                                <p className="text-gray-600 text-sm">Pendaftaran jalur reguler. Kuota terbatas.</p>
                            </div>
                            <div className="relative">
                                <span className="absolute -left-[31px] top-1 w-4 h-4 rounded-full bg-gray-300 ring-4 ring-white"></span>
                                <h4 className="font-bold text-gray-900">Masa Ta'aruf Siswa (MATSAMA)</h4>
                                <p className="text-emerald-700 font-medium text-sm mb-1">Juli 2026</p>
                ...
                <div className="space-y-6">
                    <div className="bg-emerald-950 p-8 rounded-2xl text-white shadow-xl relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-gold/10 rounded-full blur-2xl -translate-y-1/2 translate-x-1/2"></div>
                        <h3 className="font-display font-bold text-2xl mb-4 relative z-10">Daftar Sekarang?</h3>
                        <p className="text-emerald-200 mb-8 relative z-10 text-sm">
                            Anda dapat mendaftar secara online melalui formulir di bawah ini atau datang langsung ke madrasah.
                        </p>
                        <button className="w-full py-3 bg-gold hover:bg-gold-light text-emerald-950 font-bold rounded-xl shadow-lg hover:shadow-gold-glow transition-all duration-300 mb-4 relative z-10">
                            Isi Formulir Online
                        </button>
                        <button className="w-full py-3 border border-white/20 hover:bg-white/10 text-white font-medium rounded-xl transition-all duration-300 relative z-10">
                            Download Brosur
                        </button>
                    </div>
