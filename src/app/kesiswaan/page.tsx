...
export default function KesiswaanPage() {
    return (
        <div className="pt-24 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-emerald-900 to-emerald-800 rounded-3xl overflow-hidden shadow-2xl mb-20 text-white relative">
                <div className="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/2 blur-2xl"></div>
                <div className="absolute bottom-0 left-0 w-48 h-48 bg-gold/10 rounded-full translate-y-1/2 -translate-x-1/2 blur-2xl"></div>

                <div className="relative z-10 p-8 md:p-12 lg:p-16 flex flex-col md:flex-row items-center gap-12">
                    <div className="flex-1 text-center md:text-left">
                        <span className="inline-block px-4 py-1.5 rounded-full bg-gold/20 text-gold font-bold text-sm mb-6 border border-gold/30">
                            Organisasi Induk
                        </span>
                    ...
                    <div className="w-full md:w-1/3 flex justify-center">
                        ...
                        <div className="w-64 h-64 bg-emerald-950/50 rounded-full border-4 border-white/10 flex items-center justify-center relative overflow-hidden group">
                            ...
                            <span className="text-emerald-700/50 font-display font-bold text-8xl select-none">NU</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <h3 className="font-display font-bold text-2xl text-emerald-900 mb-8 border-l-4 border-gold pl-4">
                Program Pembiasaan
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                    ...
                    <div key={idx} className="bg-white p-6 rounded-xl shadow-sm border border-emerald-50 hover:shadow-md transition-shadow">
